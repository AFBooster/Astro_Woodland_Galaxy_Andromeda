/* Woodlands Galaxy Night-Sky — SINGLE SOURCE OF TRUTH for the site version.
 *
 * Bump SCOB_VERSION here on every release. The version/copyright footer on
 * every page (Woodland_Galaxy.html, telescope-types.html, moon-tonight.html,
 ...
 */
window.SCOB_VERSION   = 'v1.1';
window.SCOB_COPYRIGHT = '© 2026 Woodlands Galaxy Night-Sky';   // year of creation — do not roll forward

(function () {
  function fill() {
    var html = 'Woodlands Galaxy Night-Sky <b>' + window.SCOB_VERSION + '</b> · ' + window.SCOB_COPYRIGHT;
