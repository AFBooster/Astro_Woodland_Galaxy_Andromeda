 ...
 *   - Woodland_Galaxy.html (coords, NEA PSI region, 2-hr forecast area, fleet run-sheet)
...
window.SITE_CONFIG = {
  ...
  // --- Telescope fleet ------------------------------------------------------
  // Confirmed instruments: a 30 cm (12") reflector in the level-6 Andromeda dome,
  // and Takahashi Sky 90 apochromatic refractors used on the rooftop for the public.
  FLEET: {
    dome: [
      { name: 'Andromeda dome telescope', aperture: '30 cm (12")', type: 'reflector', note: "The observatory's main telescope, in the level-6 dome." }
    ],
    rooftop: [
      { name: 'Takahashi Sky 90', aperture: '90 mm (f/5.6)', type: 'fluorite apochromatic refractor', note: 'Rooftop scopes for public sessions — wide-field, beginner-friendly, astrophotography-capable.' }
    ]
  }
};
